...
if TYPE_CHECKING:
    ...
    from app.models import Investment, Transaction, User, PortfolioAccess
...
class Portfolio(db.Model):
    ...
    access_grants: Mapped[List['PortfolioAccess']] = relationship('PortfolioAccess', back_populates='portfolio', lazy='selectin')
